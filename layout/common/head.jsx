...
module.exports = class extends Component {
    render() {
        ...
        const { url_for, cdn, fontcdn, iconcdn, blogcdn, is_post } = helper;
        const {
            url,
            head = {},
            article,
        ...
        return <head>
            ...
            {favicon ? <link rel="icon" href={blogcdn(url_for(favicon))} /> : null}
            <link rel="stylesheet" href={iconcdn()} />
            {hlTheme ? <link rel="stylesheet" href={cdn('highlight.js', '9.12.0', 'styles/' + hlTheme + '.css')} /> : null}
            <link rel="stylesheet" href={fontCssUrl[variant]} />
            <link rel="stylesheet" href={blogcdn(url_for('/css/' + variant + '.css'))} />
